 ...
 *
 * Compile as follows:
 * gcc -o jacobi_solver jacobi_solver.c compute_gold.c compute_using_omp.c -fopenmp -std=c99 -Wall -O3 -lm 
...
int main(int argc, char **argv) 
{
	if (argc < 3) {
		...
		fprintf(stderr, "num_threads: number of threads to be used to parallelize using OpenMP\n");
		exit(EXIT_FAILURE);
	}
